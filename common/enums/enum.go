...
var (
	...
	PgsqlPwdEnum = enumx.NewStringEnum[string]().
		Add("dev00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.206", 5432, "postgres", "lanhu_096b395eb969")).
		Add("test00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.204", 5432, "postgres", "lanhu_096b395eb969")).
		Add("lanhuhu", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.205", 5432, "postgres", "lanhu_096b395eb969")).
		Add("localhost", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "localhost", 5432, "postgres", "postgres"))
	MysqlPwdEnum = enumx.NewStringEnum[string]().
		Add("dev00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.206", 3306, "root", "lanhu_096b395eb969")).
		Add("test00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.204", 3306, "root", "lanhu_096b395eb969")).
		Add("lanhuhu", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.205", 3306, "root", "lanhu_096b395eb969")).
		Add("localhost", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "localhost", 3306, "root", "mysql123qc"))
	RedisPwdEnum = enumx.NewStringEnum[string]().
		Add("dev00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.206", 6379, "", "lanhu_096b395eb969")).
		Add("test00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.204", 6379, "", "lanhu_096b395eb969")).
		Add("lanhuhu", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.205", 6379, "", "lanhu_096b395eb969")).
		Add("localhost", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "localhost", 6379, "", "Init@123"))
	MongoPwdEnum = enumx.NewStringEnum[string]().
		Add("dev00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.206", 27017, "huhu", "lanhu_096b395eb969")).
		Add("test00", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.204", 27017, "huhu", "lanhu_096b395eb969")).
		Add("lanhuhu", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "172.19.14.205", 27017, "huhu", "lanhu_096b395eb969")).
		Add("localhost", fmtx.Green.XSPrintf("host: %-16s port: %d username: %-10s password: %s", "localhost", 27017, "huhu", "Init@123"))
)
